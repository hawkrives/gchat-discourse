    ...
    def export_reaction(self, reaction_id: str) -> Optional[bool]:
        ...
        if not result:
            ...
            self.failed_manager.record_failure(
                "reaction", reaction_id, "export", "Message not exported", blocked_by=message_id
            )
            return None
        ...
        try:
            ...
            logger.info(
                "reaction_exported", reaction_id=reaction_id, post_id=post_id, emoji=discourse_emoji
            )
            ...
            logger.error("reaction_export_failed", reaction_id=reaction_id, error=str(e))

            self.failed_manager.record_failure(
                "reaction", reaction_id, "export", str(e), blocked_by=message_id
            )
