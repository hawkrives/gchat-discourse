...
def test_reaction_exporter_exports_reaction(
    ...
    chat_conn.execute("""
        ...
        VALUES ('msg1', 'thread1', 'space1', 'user1', 'Hello world!', '2025-01-01 10:00:00')
    """)
    chat_conn.execute("""
    ...
    exporter = ReactionExporter(client, state_conn, chat_conn, failed_manager)
...
def test_reaction_exporter_skips_already_exported(
    discourse_dbs: tuple[sqlite3.Connection, sqlite3.Connection],
) -> None:
...
def test_reaction_exporter_handles_blocked_reaction(
    discourse_dbs: tuple[sqlite3.Connection, sqlite3.Connection],
) -> None:
...
def test_reaction_exporter_handles_message_not_exported(
    discourse_dbs: tuple[sqlite3.Connection, sqlite3.Connection],
) -> None:
