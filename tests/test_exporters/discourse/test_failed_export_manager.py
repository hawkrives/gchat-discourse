...
def test_failed_export_manager_records_failure(
...
def test_failed_export_manager_increments_error_count(
    discourse_dbs: tuple[sqlite3.Connection, sqlite3.Connection],
) -> None:
...
def test_failed_export_manager_permanent_failure(
    discourse_dbs: tuple[sqlite3.Connection, sqlite3.Connection],
) -> None:
    ...
    should_retry = manager.record_failure(
        entity_type="thread", entity_id="thread1", operation="export", error_message="404 Not Found"
    )
...
def test_failed_export_manager_max_retries(
    discourse_dbs: tuple[sqlite3.Connection, sqlite3.Connection],
) -> None:
...
def test_failed_export_manager_get_ready_retries(
    discourse_dbs: tuple[sqlite3.Connection, sqlite3.Connection],
) -> None:
...
def test_failed_export_manager_blocked_exports(
    discourse_dbs: tuple[sqlite3.Connection, sqlite3.Connection],
) -> None:
...
def test_failed_export_manager_mark_success(
    discourse_dbs: tuple[sqlite3.Connection, sqlite3.Connection],
) -> None:
...
def test_failed_export_manager_force_retry(
    discourse_dbs: tuple[sqlite3.Connection, sqlite3.Connection],
) -> None:
